...
import 'package:nexo_errors/src/localization/failure_user_message_catalog.dart';
...
/// Russian UI strings for [Failure] (default for [Failure.userMessage]).
final class RuFailureUserMessages implements FailureUserMessageCatalog {
  const RuFailureUserMessages();
